            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  "bg-white shadow-xl",
                  "dark:bg-slate-900 dark:shadow-[2px_2px_4px_rgba(0,0,0,0.4),-1px_-1px_3px_rgba(255,255,255,0.1)]",
                )}
                style={{
              ...
              >
                {showArrows && isCurrentCard && (
                  <div className="absolute inset-x-0 top-2 flex justify-between px-4">
                    <span className="text-2xl select-none cursor-pointer text-gray-300 hover:text-gray-400 dark:text-slate-600 dark:hover:text-slate-300">
                      &larr;
                    </span>
                    <span className="text-2xl select-none cursor-pointer text-gray-300 hover:text-gray-400 dark:text-slate-600 dark:hover:text-slate-300">
                      &rarr;
